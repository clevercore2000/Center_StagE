...
public class BezierCurve implements Enums.Pathing, Paths {
    ...
    public BezierCurve(double increment) { this.increment = increment; }

    private BezierCurve(List<Point> pathPoints, double increment) {
    ...
    public BezierCurve addPoint(Point newPoint) {
        ...
        return new BezierCurve(pathPoints, increment);
    }
