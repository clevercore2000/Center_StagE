...
public class ServoTest extends LinearOpMode {
    ...
    private static List<String> names = Arrays.asList("drone", "gripper", "left_arm", "right_arm", "rotation", "FL_servo", "FR_servo", "BL_servo", "BR_servo");
    private static int i = 4, second_i = 3;

    private double position = 0.32;
